...
---
## Setup your project
Before you start analysing data make sure to get familiar with the [Resources](#resources) at your disposal. In addition to the information on that page, know that we use `git` and `SLURM` to ensure reproducible research, here are gists on how to use them in your projects:
